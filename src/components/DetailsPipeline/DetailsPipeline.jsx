...
import { groupBy, forEach, isEmpty, isEqual, map } from 'lodash'
...
const DetailsPipeline = ({ selectedItem }) => {
  ...
  const computedGraphElements = useMemo(() => {
    ...
    const { nodes, edgesMap, cyclicEdgesMap, errorsMap, nodesConnectionMap, defaultErrorHandlerData } =
  ...
  if (
    ...
    !isEqual(defaultErrorHandlerData, computedDefaultErrorHandlerData)
  ) {
    setDefaultErrorHandlerData(computedDefaultErrorHandlerData)
  }
