...
import {
  ...
  IMAGE_NAME_TOOLTIP_TEXT,
  BASE_IMAGE_TOOLTIP_TEXT
} from './applicationConfiguration.constants'
import { getBuildItems } from './applicationConfiguration.util'
import { applicationShape } from './applicationConfiguration.propTypes'

const BuildSection = ({ application }) => {
  const items = useMemo(() => {
    const rawItems = getBuildItems(application)
