...
import {
  ...
  SPOT_NODES_TOOLTIP_TEXT
} from './applicationConfiguration.constants'
import { getResourcesItems } from './applicationConfiguration.util'
import { applicationShape } from './applicationConfiguration.propTypes'

const ResourcesSection = ({ application }) => {
  const items = useMemo(() => {
    const rawItems = getResourcesItems(application)
