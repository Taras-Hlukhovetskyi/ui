...
const UrlCell = ({ items = [] }) => {
  ...
  useEffect(() => {
    ...
    // Leading-edge throttle: the first observation (fired as soon as the browser reports the
    // observed element's size) recalculates immediately; further callbacks within
    // RESIZE_THROTTLE_MS are skipped so continuous resizing doesn't over-fire.
