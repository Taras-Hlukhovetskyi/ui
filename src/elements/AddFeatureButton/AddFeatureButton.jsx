...
const AddFeatureButton = ({ feature }) => {
  ...
  const groupedFeatures = tableStore.features.groupedFeatures?.[tableStore.features.currentProject]

  const isFeatureInList = Boolean(
    groupedFeatures?.find(
      featureInList =>
  ...
  const isFeatureInvalid = Boolean(
    groupedFeatures?.find(
      featureInList =>
        featureInList.featureSet === feature.metadata.name &&
        featureInList.tag !== feature.metadata.tag
