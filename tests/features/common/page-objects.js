...
such restriction.
*/
import commonPagesHeader from './page-objects/commonPagesHeader.po.js'
import project from './page-objects/project.po.js'
import projects from './page-objects/projects.po.js'
import featureStore from './page-objects/feature-store.po.js'
import infoPane from './page-objects/info-pane.po.js'
import interactivePopup from './page-objects/interactive-popup.po.js'
import sidePanel from './page-objects/side-panel.po.js'
import jobsAndWorkflows from './page-objects/jobs-and-workflows.po.js'
import jobsMonitoring from './page-objects/jobs-monitoring.po.js'
import alertsMonitoring from './page-objects/alerts-monitoring.po.js'
import Functions from './page-objects/ml-functions.po.js'
import projectsSettings from './page-objects/project-settings.po.js'
import files from './page-objects/files.po.js'
import models from './page-objects/models.po.js'
import documents from './page-objects/documents.po.js'
import alerts from './page-objects/alerts.po.js'
import monitoringApp from './page-objects/monitoring-app.po.js'
import llmPrompts from './page-objects/llm-prompts.po.js'
